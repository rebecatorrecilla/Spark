...
spark = SparkSession.builder \
    .appName("ActorDirectorDF") \
    .getOrCreate()

df = spark.read.csv("infoActorsx10.csv", header=True, schema=schema, escape="\\") \
    .select("actor", "actorName", "director", "directorName", "averageRating") \
    .repartition(200, "actor", "director") \
    .cache()
